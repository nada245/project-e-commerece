...
import { FaFacebook, FaUserPlus } from 'react-icons/fa'; // Corrected import statement
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <button className='btn btn-primary w-100 mb-4'>
                                <MdSearch size={32} /> Sign up with Geogle
                            </button>
                            <button className='btn btn-primary w-100 mb-4'>
                                <FaFacebook size={32} /> Sign up with facebook
                            </button>
                            <form>
                                <div className="mb-3">
